    ...
    <footer className="footer">
      ...
      <div className="footer-container">
        ...
        <div className="footer-col">
          ...
          <ul className="footer-contact-info">
            <li>
              ...
              <span>Av. Exemplo, 1234 - Centro<br/>São Paulo - SP, 01001-000</span>
            </li>
            <li>
        ...
        <div className="footer-col">
          ...
          <p className="footer-description">
            Inscreva-se para receber atualizações e dicas de segurança diretamente no seu e-mail.
          </p>
          <form className="newsletter-form">
            ...
            <div className="form-text text-white-50">
              Não compartilhamos seus dados. Leia nossa <a href="#" className="text-white">Política de Privacidade</a>.
            </div>
          </form>
        </div>
      </div>
